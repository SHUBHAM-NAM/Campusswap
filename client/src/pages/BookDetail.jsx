      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-md overflow-hidden">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-4 mt-6 bg-gray-50 rounded-xl p-4">
            ...
            <div>
              ...
              <p className={`font-semibold
                ${book.condition === 'Good' ? 'text-green-600' :
                  book.condition === 'Fair' ? 'text-yellow-600' : 'text-red-600'}`}>
                {book.condition}
              </p>
            </div>
            <div>
          ...
          <div className="mt-6 bg-blue-50 rounded-xl p-4">
            ...
            <p className="text-gray-500 text-sm">Branch: {book.seller?.branch} | Sem: {book.seller?.semester}</p>
